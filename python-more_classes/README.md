...
Style: All code adheres to the pycodestyle (version 2.8.*) standard.
...
bash git clone https://github.com/holbertonschool-higher_level_programming.git cd python-more_classes

Execution: Run the provided main files to test the classes:
bash chmod +x 0-main.py ./0-main.py
